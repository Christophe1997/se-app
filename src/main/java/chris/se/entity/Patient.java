...
public class Patient {
    ...
    @Column(name = "出生日期") private @Temporal(TemporalType.TIMESTAMP) Date birthday; // 生日
    ...
    @Column(name = "就诊卡号") private Long visitCardNumber; // 就诊卡号
    ...
    @Column(name = "合同单位ID") private Long contractCompanyId; // 合同单位ID
    ...
    @Column(name = "担保性质") private String guaranteedProperty; // 担保性质

    @Column(name = "就诊时间") private @Temporal(TemporalType.TIMESTAMP) Date visitTime; // 就诊时间
    @Column(name = "就诊状态") private Integer visitStatus; // 就诊状态
    @Column(name = "就诊诊室") private String visitRoom; // 就诊诊室
    @Column(name = "住院次数") private Integer hospitalizationTimes; // 住院次数
    ...
    @Column(name = "入院时间") private @Temporal(TemporalType.TIMESTAMP) Date admissionTime; // 入院时间
    @Column(name = "住院时间") private @Temporal(TemporalType.TIMESTAMP) Date lengthOfStay; // 住院时间
    @Column(name = "在院") private Integer ishospitalization; // 在院
    ...
    @Column(name = "险类") private Integer insuranceCategiry; // 险类
    @Column(name = "登记时间") private @Temporal(TemporalType.TIMESTAMP) Date registrationTime; // 登记时间
    @Column(name = "停用时间") private @Temporal(TemporalType.TIMESTAMP) Date downTime; // 停用时间
    @Column(name = "锁定") private Integer locked; // 锁定
